                                                        ...
                                                        <tr>
                                                            <td style="width: 50%;">
                                                                <div class="thumbnail"
                                                                    ...
                                                                    <!-- 상품 이미지 사진 -->
                                                                    <img src="${Gu_ProductView.proimg}" width="100%"
                                                                        height="100%" alt="이미지">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="width: 50%;">
                                                                <div class="infoArea" style=" height: 400px;">
                                                                    <table
                                                                        style="text-align: left; margin-left: 100px; width: 100%; height: 100%">
                                                                        <tr>
                                                                            <td colspan="2" width="200">
                                                                                <input id="procode" type="hidden"
                                                                                    value="${Gu_ProductView.procode}">
                                                                                <input id="catecode" type="hidden"
                                                                                    value="${Gu_ProductView.catecode}">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>상품이름</td>
                                                                        ...
                                                                        <tr>
                                                                            <td>상품가격</td>
                                                                            <td colspan="2"><span
                                                                                    id="proprice">${Gu_ProductView.proprice}</span>
                                                                                원
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>할인가격</td>
                                                                            <td colspan="2"><span
                                                                                    id="prosale">${Gu_ProductView.prosale}
                                                                                </span>원</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>상품색상 선택</td>
                                                                            <td colspan="2">
                                                                                <select id="optionColor">
                                                                                    ...
                                                                                    <optgroup label="상품옵션">
                                                                                        <c:forEach var="color"
                                                                                            items="${Gu_ProductView.colorOptions}"
                                                                                            varStatus="status">
                                                                                            <c:if
                                                                                                test="${not empty color}">
                                                                                                <option
                                                                                                    id="color${status.index + 1}"
                                                                                                    value="${color}">
                                                                                                    ${color}</option>
                                                                                            </c:if>
                                                                                        </c:forEach>
                                                                        ...
                                                                        <tr id="insertRow">
                                                                            ...
                                                                            <td colspan="2">
                                                                                <select id="optionSize">
                                                                                    ...
                                                                                    <optgroup label="상품옵션">
                                                                                        <c:forEach var="size"
                                                                                            items="${Gu_ProductView.sizeOptions}"
                                                                                            varStatus="status">
                                                                                            <c:if
                                                                                                test="${not empty size}">
                                                                                                <option
                                                                                                    id="size${status.index + 1}"
                                                                                                    value="${size}">
                                                                                                    ${size}</option>
                                                                                            </c:if>
                                                                                        </c:forEach>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="3" align="right">
                                                                                ...
                                                                                <input type="hidden" id="proname"
                                                                                    name="proname"
                                                                                    value="${ProductView.proname}">
                                                                                <input type="hidden" id="procode"
                                                                                    name="procode"
                                                                                    value="${ProductView.procode}">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>상품설명</td>
                                                                            <td colspan="2">${Gu_ProductView.proinfo}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                        ...
                                        <div id="prdReview">
                                            <div class="board">
                                                <div class="board2">
                                                    ...
                                                    <table border="1" class="rv" style="width: 835px;">
                                                        <tr>
                                                            <td width="80px">No</td>
